...
import "./mocks/MockWeb3sdksContract.sol";
...
contract TWFactoryTest is ITWFactoryData, BaseTest {
    ...
    // Test params
    MockWeb3sdksContract internal mockModule;
    ...
    function setUp() public override {
        ...
        mockModule = new MockWeb3sdksContract();
    }
    ...
    function test_addImplementation_directV2() public {
        MockWeb3sdksContractV2 mockModuleV2 = new MockWeb3sdksContractV2();
    ...
    function test_deployProxyByImplementation(bytes32 _salt) public {
        ...
        assertEq(mockModule.contractType(), MockWeb3sdksContract(computedProxyAddr).contractType());
    }
    ...
    function test_deployProxy() public {
        ...
        assertEq(mockModule.contractType(), MockWeb3sdksContract(proxyAddr).contractType());
    }
